...
into a real microVM/container via the in-provider
...
class SandboxToolset(AbstractToolset[Any]):
    ...
    async def __aenter__(self) -> SandboxToolset:
        ...
        from airflow.providers.common.ai.sandbox.loader import load_provider
    ...
    async def call_tool(
        ...
        def _exec() -> str:
            from airflow.providers.common.ai.sandbox.base import SandboxState
