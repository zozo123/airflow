...
from airflow.providers.common.ai.sandbox.base import SandboxProvider

_BUILTIN: dict[str, str] = {
    "local": "airflow.providers.common.ai.sandbox.local:LocalProvider",
    "daytona": "airflow.providers.common.ai.sandbox.daytona:DaytonaProvider",
    "e2b": "airflow.providers.common.ai.sandbox.e2b:E2BProvider",
    "modal": "airflow.providers.common.ai.sandbox.modal:ModalProvider",
    "islo": "airflow.providers.common.ai.sandbox.islo:IsloProvider",
}
